...
const PrivacyPolicy: FC<P> = () => {
    return <div className='pt-5'>
        <h1 className='text-4xl py-4 font-bold text-center '>PRIVACY POLICY</h1>
        <div className='m-3 p-3 text-justify rounded-xl border border-gray-500 '>
            ...
            <h1 className='text-xl font-bold text-black '>Purpose and Usage:</h1>
            <p>
            ...
            <p className='py-4'>
                Username 2. Password 3. Email address 4. Date of birth In the course of providing you with access to the Services, and in order to provide you access to the features offered through the Portal and to verify your identity, secure your account details, you may give us the permission to capture, record your device information, operating system information, network information, location information. You may also be required to furnish additional information, including your Permanent Account Number. In certain instances, we may also collect Sensitive Personal Information (“SPI”) from you on the Portal. SPI means such personal information which consists of information relating to your physical, physiological and mental health condition; medical records and history; biometric information, sexual orientation and financial information, such as information regarding the payment instrument/modes used by you to make such payments, which may include cardholder name, credit/debit card number (in encrypted form) with expiration date, banking details, wallet details etc. This information is presented to you at the time of making a payment to enable you to complete your payment expeditiously.
            </p>

            <p>
                Except for any financial information that you choose to provide while making payment for any Services on the Portal, Pro11Club does not collect any other SPI in the course of providing the Services. Any SPI collected by Pro11Club shall not be disclosed to any third party without your express consent, save as otherwise set out in this Privacy Policy or as provided in a separate written agreement between Pro11Club and you or as required by law. It is clarified that this condition shall not apply to publicly available information, including SPI, in relation to you on the Portal. In the course of providing the Services, Users may invite other existing Users or other users (“Invited Users”) to participate in any of the Services by providing the email address or Facebook username of such users. Pro11Club may thereafter use this information to contact the Invited User and invite such user to register with Pro11Club (if such Invited User is not an existing User) and participate in the Game in relation to which such person was invited by the User. The participation of the Invited User in any of the Gameshall be subject to the terms of this Privacy Policy and the Terms and Conditions for the use of the Portal. The User hereby represents that the Invited Users have consented and agreed to such disclosure to and use of their email address and Facebook username by Pro11Club. All required information is specific and based on the kind of Game/ Services the User wishes to participate in or access, and will be utilized for the purpose of providing services, including but not limited to the Services requested by the User. The information as supplied by the Users enables us to improve the Services and provide you the most user-friendly game experience.
                Pro11club may also share such information with affiliates and third parties in limited circumstances, including for the purpose of providing services requested by the User, complying with legal process, preventing fraud or imminent harm, and ensuring the security of our network and services.
            </p>

            <h1 className='text-xl font-bold text-black pt-4'>Disclosure/Sharing:</h1>
            <p>
                Pro11Club may also share information as provided by you and data concerning usage of the Services and participation in the Games with third party service providers engaged by Pro11Club, for the purpose of data analytics or other similar purposes, for the purpose of storage, improving the services and helping Pro11Club serve you better. Where we propose to use your personal information (that is, information that that may be used to identify the User and that is not otherwise publicly available) for any other uses we will ensure that we notify you first. You will also be given the opportunity to withhold or withdraw your consent for your use other than as listed above. By using the Portal, you hereby expressly agree and grant consent to the collection, use and storage of this information by Pro11Club. Pro11Club reserves the right to share, disclose and transfer information collected hereunder with its own affiliates. In the event Pro11Club sells or transfers all or a portion of its business assets, consumer information may be one of the business assets that are shared, disclosed or transferred as part of the transaction. You hereby expressly grant consent and permission to Pro11Club for disclosure and transfer of information to such third parties. Pro11Club may share information as provided by you and data concerning usage of the Services and participation in the Game with its commercial partners for the purpose of facilitating user engagement, for marketing and promotional purposes and other related purposes. Further, Pro11Club reserves the right to disclose personal information as obligated by law, in response to duly authorized legal process, governmental requests and as necessary to protect the rights and interests of Pro11Club.
            </p>

            <h1 className='text-xl font-bold text-black pt-4'>Use of Cookies:</h1>
            <p>
            ...
            <h1 className='text-xl font-bold text-black pt-4'>Links:</h1>
            <p>
            ...
            <h1 className='text-xl font-bold text-black pt-4'>Security Procedures:</h1>
            <p>
                All information gathered on Agnee11 is securely stored within Agnee11- controlled database. The database is stored on servers secured behind a firewall; access to such servers being password-protected and strictly limited based on need-to-know basis. However, we understand that as effective as our security measures are, no security system is impenetrable. Thus, we cannot guarantee the security of our database, nor can we guarantee that information you supply will not be intercepted while being transmitted to us over the Internet. Further, any information you include in a posting to the discussion areas will be available to anyone with Internet access. By using the Portal, you understand and agree that your information may be used in or transferred to countries other than India.
            </p>

            <p className='py-4'>
                Agnee11 also believes that the internet is an ever-evolving medium. We may periodically review from time to time and change our privacy policy to incorporate such future changes as may be considered appropriate, without any notice to you. Our use of any information we gather will always be consistent with the policy under which the information was collected, regardless of what the new policy may be. Any changes to our privacy policy will be posted on this page, so you are always aware of what information we collect, how we use it, how we store it and under what circumstances we disclose it.
            </p>

            <h1 className='text-xl font-bold text-black pt-4'>Advertising:</h1>
            <p className='py-4'>
                 When Pro11Club presents information to its online advertisers – to help them understand our audience and confirm the value of advertising on the Portal – it is usually in the form of aggregated statistics on traffic to various pages within our site. When you register with Pro11Club, we contact you from time to time about updating your content to provide features which we believe may benefit you. Several deceptive emails, websites, blogs etc. claiming to be from or associated with Pro11Club may or are circulating on the Internet. These emails, websites, blogs etc. often include our logo, photos, links, content or other information. Some emails, websites, blogs etc. call the user requesting the user to provide login name, password etc. or inform the user that the user has won a prize/ gift or provide a method to commit illegal/ unauthorized act or deed or request detailed personal information or a payment of some kind. The sources and contents of these emails, websites, blogs etc. and accompanying materials are in no way associated with Pro11Club. For your own protection, we strongly recommend not responding to such emails or using these websites, blogs etc. We may use the information provided by you to Pro11Club, including your email address or phone number, to contact you about the Services availed by you or to inform you of our updated Services if any.
            </p>

            <h1 className='text-xl font-bold text-black pt-4'>Conditions of Use:</h1>
            <p>
                PRO11CLUB DOES NOT WARRANT THAT THIS PORTAL, ITS SERVERS, OR EMAIL SENT BY US OR ON OUR BEHALF ARE VIRUS FREE. PRO11CLUB WILL NOT BE LIABLE FOR ANY DAMAGES OF ANY KIND ARISING FROM THE USE OF THIS PORTAL, INCLUDING, BUT NOT LIMITED TO COMPENSATORY, DIRECT, INDIRECT, INCIDENTAL, PUNITIVE, SPECIAL AND CONSEQUENTIAL DAMAGES, LOSS OF DATA, GOODWILL, BUSINESS OPPORTUNITY, INCOME OR PROFIT, LOSS OF OR DAMAGE TO PROPERTY AND CLAIMS OF THIRD PARTIES. IN NO EVENT WILL PRO11CLUB BE LIABLE FOR ANY DAMAGES WHATSOEVER IN AN AMOUNT IN EXCESS OF AN AMOUNT OF INR 100.
            </p>

            <h1 className='text-xl font-bold text-black pt-4'>Retention of Data:</h1>
            <p>
            ...
            <h1 className='text-xl font-bold text-black pt-4'>User Account and Data Deletion:</h1>
            <p>
                Users are entitled to request Pro11Club to delete their User accounts and their personal information by sending an email with their written request to help@pro11club.com We will do our best to respond promptly and in any event within one month of the following: · Our receipt of your written request; or · Our receipt of any further information we may ask you to provide to enable us to comply with your request, whichever is later. As an alternative to account deletion, by writing to help@pro11club.com, you also have the option to request either:
            </p>
            ...
            <h1 className='text-xl font-bold text-black pt-4'>Applicable Law and Jurisdiction:</h1>
            <p>
            ...
            <h1 className='text-xl font-bold text-black pt-4'>Updating Information:</h1>
            <p>
                You will promptly notify Pro11club if there are any changes, updates or modifications to your information. Further, you may also review, update or modify your information and user preferences by logging into your Profile page on the Portal.
            </p>

            <h1 className='text-xl font-bold text-black pt-4'>Contact Us:</h1>
            <p>
                Any questions or clarifications with respect to this Policy or any complaints, comments, concerns or feedback can be sent to Pro 11 Club at: help@pro11club.com or by normal/physical mail addressed to: Attn: Pro 11 Club Team GoPro Universe Gaming Private Limited Umari, Near Nutan School, Satna - 485001.
            </p>
