...
import BattingPoint from '../../../public/BattingPoint.svg'
    ...
    return <div className='m-3 font-outline text-justify '>
        <div className='flex flex-col'>
            ...
            <div className='border  border-gray-700 relative  rounded-xl p-3 sm:max-w-6xl sm:mx-auto'>
                ...
                <h1 className='font-bold text-black text-2xl '>Purpose and Usage:</h1>
                ...
                <h1 className='font-bold text-2xl text-black '>Disclosure/Sharing:</h1>
                <p className='pb-5'>
                ...
                <h1 className='font-bold text-2xl text-black'>Use of Cookies:</h1>
                <p className='pb-5'>
                ...
                <h1 className='font-bold text-2xl text-black'>Security Procedures:</h1>
                <p className='pb-5'>
                ...
                <h1 className='font-bold text-2xl text-black'>Advertising:</h1>
                <p className='pb-5'>
                ...
                <h1 className='font-bold text-xl text-black'>Conditions of Use:</h1>
                <p className='pb-5'>
                ...
                <h1 className='font-bold text-2xl text-black'>Retention of Data:</h1>
                <p className='pb-5'>
                ...
                <h1 className='font-bold text-2xl text-black'>User Account and Data Deletion:</h1>
                <p className=''>
                ...
                <h1 className='font-bold text-2xl text-black'>Updating Information:</h1>
                <p className='pb-5'>
        ...
        <div className=''>
            <p className='py-5 pt-10 font-bold text-3xl text-center'>WHAT MAKES US UNIQUE</p>
            <div className='border border-gray-700 rounded-xl p-3'>
                ...
                <div>
                    ...
                    <div className='text-black'>
                        <h1 className='text-3xl '>T10</h1>
                        <h2 className='text-2xl py-4 '>Batting</h2>
                        <img src={BattingPoint} alt="Batting Point" className='py-3 w-full' />
