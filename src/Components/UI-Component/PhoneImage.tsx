...
const PhoneImage: FC<P> = () => {
    return <div className=' py-10 '>
        ...
        <div className='w-full h-full relative  flex flex-col justify-center'>
            <div className='w-full h-80 bg-gradient-to-r from-blue-600 to-pink-400 top-32  sm:h-[450px] rounded-full sm:max-w-md mx-auto self-center absolute z-0 blur-3xl '> </div>
